...
#page(
  ...
  #dnd.page.spellsSection(
    ...
    spell(
      ...
      Вы касаетесь согласного существа, даруя ему скорость полёта 60 футов.
      Когда заклинание оканчивается, цель падает, если не может парить или удержаться в воздухе.
      #atHigherLevels[+1 цель за каждый уровень ячейки выше 3-го]
    ],
    ...
    spell(
      ...
      Вы выбираете существо, предмет или магический эффект в пределах дистанции.
      Все заклинания 3 уровня и ниже на цели оканчиваются, а для более высоких совершается проверка характеристики против Сл 10 + уровень.
      #atHigherLevels[Автоматически оканчивает эффекты с уровнем не выше использованной ячейки.]
    ]
  )
]
...
#page(
  ...
  #dnd.page.spellsSection(
    ...
    spell(
      ...
      Вы телепортируетесь в выбранную точку в пределах дистанции, куда можете видеть, представить или точно описать направление и расстояние.
      Вы можете взять одно согласное существо рядом с собой и переносимые предметы.
      Если место занято, телепортация не удаётся, и вы получаете #damage("4d6", force).
    ],
...
#dnd.page.abilities(
  ...
  ability("Воззвание:\nПризрачный взор", source: "Колдун 7ур")[
  ...
  ability("Сияющая душа", source: "Колдун 7ур")[
    +ХАР к изл. и огню
  ],
)
